        ...
        <>
            ...
            <div style={containerStyle}>
                <form noValidate autoComplete="off" style={containerStyle}>
                    ...
                    <TextField id="otline-basic" label="Пароль" variant="outlined" required style={fieldForm}
                    onChange = {(e) => setPassword(e.target.value)}
                    />

                    <TextField id="otline-basic" label="Повторите пароль" variant="outlined" required style={fieldForm}
